...
<p>
This microservice performs the action of updating the movie information of a movie platform. It has an interface where it calls this microservice through a defined URL. The microservice performs this action through an endpoint and connects to a postgres database that is hosted in the cloud where the modified data is updated. The use of this microservice will depend on the user's role.
</p>
