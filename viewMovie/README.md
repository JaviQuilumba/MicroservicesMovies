...
<p>
This microservice performs the action of listing movie information and bringing it to a movie platform. It has an interface where it calls this microservice through a defined URL. The microservice performs this action through an endpoint and connects to a postgres database that is hosted in the cloud. 
</p>
